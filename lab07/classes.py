...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        mid = other_card.attack
        other_card.attack = other_card.defense
        other_card.defense = mid
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        a = opponent.deck.cards[:]
        for s in a:
            if other_card.attack == s.attack or other_card.defense == s.defense:
                opponent.deck.cards.remove(s)         
